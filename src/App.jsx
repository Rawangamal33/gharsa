...
// import UserGroup from "./user/myGroup/UserGroup";
// import AddNemGroupUser from "./user/myGroup/AddNemGroupUser";
// import EditUserGroup from "./user/myGroup/EditUserGroup";
  ...
  const router = createBrowserRouter([
    {
      ...
      children: [
        ...
        //     { path: "adduser-group", element: <AddNemGroupUser /> },
        //     { path: "edit-User-group", element: <EditUserGroup /> },
        //     { path: "orders", element: <Orders /> },
        //     { path: "order/:id", element: <OrderDetails /> },
        //     { path: "userSales", element: <UserSales /> },
        //     { path: "userAcount", element: <UserAcount /> },
